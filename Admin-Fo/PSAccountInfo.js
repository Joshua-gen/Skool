...
const PSAccountInfo = ({ route, navigation }) => {
...
const handleDeleteUser = () => {
  ...
  const handleUpdateUser = () => {
    navigation.navigate('UpdatePassenger', { user });
  };
    ...
    <View style={styles.container}>
      <View style={{backgroundColor: '#0CC0DF', width: '100%', height: 50, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between'}}>
        ...
        >
          ...
          <Text style={{fontFamily: 'Poppins-Medium', fontSize: 18, marginRight: 10, color: 'white'}}>Passenger Account</Text>
        </View>
