...
const SwipeableModal7 = ({ isVisible, onSwipeComplete, onClose, children }) => {
  return (
    <Modal
      isVisible={isVisible}
      swipeDirection={['down']}
    ...
    >
      <View style={styles.modalContent}>
        ...
        <View style={{width: '110%',justifyContent: 'space-between', flexDirection: 'row'}}>
          <Text style={{fontSize: 20, fontFamily: 'Poppins-Medium', marginLeft: 15,}}>Reject Driver Application</Text>
...
export default SwipeableModal7;
